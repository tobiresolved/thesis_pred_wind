...
class Event:
    ...
    def __str__(self) -> str:
        return (
            ...
            f"event_label={self.event_label!r}, "
            f"event_start={self.event_start.format()}, "
            f"event_start_id={self.event_start_id}, "
            f"event_end={self.event_end.format()}, "
            f"event_end_id={self.event_end_id}, "
            f"event_description={self.event_description!r}, "
